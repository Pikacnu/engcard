...
export default function DashBoardLayout({
	...
	return (
		<div className='flex flex-row max-md:flex-col-reverse w-full h-dvh dark:bg-gray-700 bg-blue-100 relative'>
			<SessionProvider>
				<div className='flex flex-col max-md:flex-row h-full bg-gray-50 md:left-0 md:top-0 max-md:h-16 max-md:bottom-0 max-md:w-full justify-between text-black items-center keyboard:hidden'>
					{isBiMenuOpen ? (
