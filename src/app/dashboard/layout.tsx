...
export default async function DashBoardLayout({
	...
	return (
		<div className='flex flex-row max-md:flex-col-reverse w-full h-dvh dark:bg-gray-700 bg-blue-100 '>
			<SessionProvider>
				<div className='flex flex-col max-md:flex-row min-w-16 h-full bg-gray-50 md:left-0 md:top-0 max-md:h-16 max-md:bottom-0 max-md:w-full justify-between text-black items-center'>
				...
				<div className='flex-grow w-full overflow-auto h-full'>{children}</div>
			</SessionProvider>
		</div>
	);
}
