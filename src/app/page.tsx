...
export default function Home() {
	return (
		<div className='flex flex-col items-center justify-center flex-grow p-0 bg-gradient-to-b from-gray-800 to-gray-900 w-full min-h-screen'>
			<NavBar />
			<div className='flex-grow flex items-center justify-center flex-col mt-8 px-4'>
				<h1 className='flex flex-col sm:flex-row items-center justify-center mb-6 text-center'>
					<span className='text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 tracking-wide'>
						English Card
					</span>
					<span className='text-xl sm:text-2xl font-bold text-blue-300 sm:ml-2 mt-2 sm:mt-0'>
				...
				<p className='text-gray-200 text-xl mt-4 max-w-2xl text-center leading-relaxed'>
					...
					featuring Imagine recognition, and interactive practice to help you
