...
export default function Spell({
  ...
  return (
    ...
    >
      {!correct && (
        <div className='flex flex-col items-center justify-center shadow-lg p-4 m-4 rounded-lg select-none bg-gray-300 dark:bg-gray-800 overflow-hidden flex-grow min-w-[20vw] h-full'>
